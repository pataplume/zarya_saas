...
export default function Loading() {
  return (
    <div className="px-4 py-8 sm:px-6 lg:px-8">
      ...
      {/* Barre d'ancres */}
      <nav className="mb-6 flex flex-wrap gap-1 rounded-lg border border-slate-200 bg-white p-1.5 shadow-sm">
      ...
      <Skeleton className="mt-10 h-64 w-full rounded-lg bg-slate-100" />
      <Skeleton className="mt-8 h-48 w-full rounded-lg bg-slate-100" />
    </div>
  );
}
